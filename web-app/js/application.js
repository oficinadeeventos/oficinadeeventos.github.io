    ...
    $(function () {
                        ...
                        if (loaded == 3) {
                            $('#bg1,#bg2,#bg3').mouseover(function (e) {
                                ...
                                if (item == 'bg1' || current == 2)
                                    $('#menu .sub' + parseInt(current + 1)).stop().animate({backgroundPosition:"(-313px 0)"}, 300, function () {
                                        $(this).find('li').hide();
                                    });
                                else
                                    $('#menu .sub' + parseInt(current + 1)).stop().animate({backgroundPosition:"(313px 0)"}, 300, function () {
                                ...
                                if (current == 2 && item == 'bg1') {
                                    $('#menu .sub' + parseInt(current)).stop().animate({backgroundPosition:"(-313px 0)"}, 300);
                                }
                                if (current == 0 && item == 'bg3') {
                                    $('#menu .sub' + parseInt(current + 2)).stop().animate({backgroundPosition:"(313px 0)"}, 300);
                                }
        ...
        function move(dir, item) {
            if (dir) {
                ...
                $('#bg2').parent().stop().animate({backgroundPosition:"(-313px 0)"}, 300);
                $('#bg3').parent().stop().animate({backgroundPosition:"(-626px 0)"}, 400, function () {
                ...
                $('#bg2').parent().stop().animate({backgroundPosition:"(-313px 0)"}, 300);
                $('#bg3').parent().stop().animate({backgroundPosition:"(-626px 0)"}, 200);
            }
        }
    });
}
